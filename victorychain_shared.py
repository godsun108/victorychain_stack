...
class RiskManager(Protocol):
    ...
    def assess_risk(
        self, signal: TradingSignal, portfolio: List[PortfolioPosition]
    ) -> RiskLevel:
...
def calculate_stop_loss(
    entry_price: float, stop_loss_pct: float, order_type: OrderType
) -> float:
...
def calculate_take_profit(
    entry_price: float, take_profit_pct: float, order_type: OrderType
) -> float:
