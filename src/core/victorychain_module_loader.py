...
def create_import_fix_suggestions():
    ...
    suggestions = {
        "victorychain_core_v2.py": [
            "Add: from core.victorychain_shared import OrderType, StrategyType, TradingConfig",
            "Replace local enum definitions with shared ones",
            "Use shared BaseTrader and TradingEngine interfaces",
        ],
        "momentum_trader_v2.py": [
            "Add: from core.victorychain_shared import TradingSignal, TradeResult",
            "Implement BaseStrategy interface",
            "Use shared configuration system",
        ],
        "launch_live_trading_v2.py": [
            "Add: from core.victorychain_core_v2 import VictoryChainCore",
            "Add: from strategies.momentum_trader_v2 import MomentumTrader",
            "Use unified TradingConfig from shared interfaces",
        ],
        "claude_auto_consolidator.py": [
            "Add: from core.victorychain_shared import AnalysisResult, ClaudeProvider",
