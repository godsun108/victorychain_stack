...
help:
	...
	@echo "sovereign-env-check Validate zero-external sovereign env baseline (ENV_FILE defaults to .env.example)"
...
sovereign-env-check:
	@./scripts/check_sovereign_env_baseline.py \
		--env-file "$${ENV_FILE:-.env.example}"
